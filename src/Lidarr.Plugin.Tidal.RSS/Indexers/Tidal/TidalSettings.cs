...
namespace NzbDrone.Core.Indexers.Tidal
{
    ...
    public class TidalIndexerSettings : IIndexerSettings
    {
        ...
        [FieldDefinition(2, Type = FieldType.Number, Label = "RSS Cache Hours", HelpText = "How long to cache RSS results before fetching from Tidal again (minimum: 24). Reduces API calls when Lidarr's RSS sync runs more frequently.", Advanced = true)]
